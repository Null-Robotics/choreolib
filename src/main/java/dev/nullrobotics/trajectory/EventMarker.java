...
package dev.nullrobotics.trajectory;
...
// public record (double timestamp, String event) {
//   /**
...
public class EventMarker {
      ...
      try {
        ...
        double offset =
            json.getAsJsonObject()
                ...
                .get("val")
                .getAsDouble();
        String event = json.getAsJsonObject().get("name").getAsString();
  ...
  public boolean equals(Object obj) {
    ...
    EventMarker other = (EventMarker) obj;
